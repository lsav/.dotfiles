...
if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
    ...
    hi Normal        guifg=#dcdccc guibg=#191919           ctermfg=188 ctermbg=235
    hi ColorColumn   guibg=#33332f                         ctermbg=236
    hi CursorLine    guibg=#121212 gui=bold                ctermbg=234 cterm=none
    hi CursorLineNr  guifg=#f2f3bb guibg=#161616           ctermfg=229 ctermbg=233
    if exists("g:zenburn_unified_CursorColumn") && g:zenburn_unified_CursorColumn
        hi CursorColumn  guibg=#121212 gui=bold            ctermbg=234 cterm=none
    else
        hi CursorColumn  guibg=#2b2b2b                     ctermbg=236 cterm=none
    endif
    hi FoldColumn    guibg=#161616                         ctermbg=234 ctermfg=109
    hi Folded        guibg=#161616                         ctermbg=234 ctermfg=109
    ...
    hi TabLine       guifg=#88b090 guibg=#313633 gui=none  ctermbg=237 ctermfg=108 cterm=none
    hi TabLineSel    guifg=#ccd990 guibg=#222222           ctermbg=236 ctermfg=186 cterm=bold
    hi TabLineFill   guifg=#88b090 guibg=#313633 gui=none  ctermbg=237 ctermfg=108 cterm=none
else
